...
const menuGroups = [
  {
    title: "Menu",
    items: [
      { icon: "mdi:view-dashboard", name: "Dashboard", path: "/" },
      { icon: "material-symbols:category-rounded", name: "Categories", path: "/categories" },
      { icon: "qlementine-icons:users-16", name: "Suppliers", path: "/suppliers" },
      { icon: "solar:box-linear", name: "Products", path: "/products" },
      { icon: "hugeicons:package-out-of-stock", name: "Stocks", path: "/stocks" },
  ...
  },
  {
    title: "Others",
    items: [
      { icon: "mdi:calendar-month", name: "Calendar", path: "/calendar" },
      { icon: "mdi:account-circle", name: "User Profile", path: "/profile" },
      {
        name: "Forms",
